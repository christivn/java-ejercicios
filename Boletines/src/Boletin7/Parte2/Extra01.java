...
public class Extra01 {
    ...
    int aux_col=col;
        ...
        if((aux_col+1)<=7 && (aux_row+2)<=7){
            n[aux_row+2][aux_col+1]=2;
        }
        
        if((aux_col+1)<=7 && (aux_row-2)>=0){
            n[aux_row-2][aux_col+1]=2;
        }
        
        if((aux_col-1)>=0 && (aux_row+2)<=7){
            n[aux_row+2][aux_col-1]=2;
        }
        
        if((aux_col-1)>=0 && (aux_row-2)>=0){
            n[aux_row-2][aux_col-1]=2;
        }
        
        if((aux_col+2)<=7 && (aux_row+1)<=7){
            n[aux_row+1][aux_col+2]=2;
        }
        
        if((aux_col+2)<=7 && (aux_row-1)>=0){
            n[aux_row-1][aux_col+2]=2;
        }
        
        if((aux_col-2)>=0 && (aux_row+1)<=7){
            n[aux_row+1][aux_col-2]=2;
        }
        
        if((aux_col-2)>=0 && (aux_row-1)>=0){
            n[aux_row-1][aux_col-2]=2;
        }
