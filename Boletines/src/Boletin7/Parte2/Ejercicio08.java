...
public class Ejercicio08 {
    ...
    int aux_col=col;
    for(int i=1;i<8;i++){
        if((aux_row+i)<=7 && (aux_col-i)>=0){
            n[aux_row+i][aux_col-i]=2;
        }
    }
